            ...
            <div className= 'row'>
                ...
                <div className = 'col-8'>
                    <ul className = 'nav nav-pills justify-content-around'>
                        ...
                        <Link to='/bookmarks' className = {`nav-item  ${pathname === '/bookmarks'?'active override-bs':''}`}>
                        ...
                        <li className='nav-item'>
                            ...
                            <a href="/Users/rushikeshmokashi/Desktop/2022/fall/webdev/web-dev-project/public#" className="nav-link text-black p-0">Login/Sign-up</a>
                        </li>
